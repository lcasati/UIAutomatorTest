...
public class Test0 {
    ...
    public void startMainActivityFromHomeScreen() {
       ...
       for (UiObject2 obj : list) {
            ...
            boolean text = obj.getText()!=null && obj.getText().equals("PREMI");
            boolean resourceId = obj.getResourceName()!=null && obj.getResourceName().equals("unibg.caciuppo:id/button");
            ...
            boolean bounds = obj.getVisibleBounds()!=null && obj.getVisibleBounds().toString().equals("Rect(425, 1437 - 656, 1563)");
