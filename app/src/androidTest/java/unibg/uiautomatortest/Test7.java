...
public class Test7 {
    ...
    public void startMainActivityFromHomeScreen() {
       ...
       for (UiObject2 obj : list) {
            ...
            boolean text = obj.getText()!=null && obj.getText().equals("Hello World!");
            boolean resourceId = obj.getResourceName()!=null && obj.getResourceName().equals("unibg.caciuppo:id/textView");
            ...
            boolean bounds = obj.getVisibleBounds()!=null && obj.getVisibleBounds().toString().equals("Rect(440, 368 - 640, 419)");
    ...
    public void testContrast() {
        ...
        File file = new File(Environment.getExternalStorageDirectory() + "/UIAccessibilityTests/screenshots/screenshot.png");
        file.delete();
