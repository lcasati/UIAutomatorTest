...
public class Test2 {
    ...
    public void startMainActivityFromHomeScreen() {
        ...
        mDevice.wait(Until.hasObject(By.pkg(PACKAGE_NAME).depth(0)),
                ...
                editTextViews = mDevice.findObjects(By.clazz("android.widget.EditText"));
       ...
       for (UiObject2 obj : list) {
            ...
            boolean text = obj.getText()!=null && obj.getText().equals("TestApp2");
            boolean resourceId = obj.getResourceName()==null;
            boolean packageName = obj.getApplicationPackage()!=null && obj.getApplicationPackage().equals("unibg.testapp2");
            boolean contentDesc = obj.getContentDescription()==null;
            boolean bounds = obj.getVisibleBounds()!=null && obj.getVisibleBounds().toString().equals("Rect(42, 101 - 269, 172)");
